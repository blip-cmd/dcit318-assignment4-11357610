...
namespace dcit318_assignment4_11357610.MedicalDBDataSetTableAdapters {
...
SELECT DoctorID, FullName, Specialty, Availability FROM Doctors WHERE (DoctorID = @DoctorID)";
        ...
        public virtual int Fill(MedicalDBDataSet.DoctorsDataTable dataTable) {
        ...
        public virtual MedicalDBDataSet.DoctorsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            MedicalDBDataSet.DoctorsDataTable dataTable = new MedicalDBDataSet.DoctorsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(MedicalDBDataSet.DoctorsDataTable dataTable) {
